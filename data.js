        ...
        "delkapitler": [
            {
                ...
                "quiz": [
                    {
                        "sporsmal": "Hvilket av disse tallene er et rasjonalt tall?",
                        "alternativer": [
                            "$\\pi$",
                            "$\\sqrt{2}$",
                            "$\\frac{3}{4}$"
                        ...
                        "riktigSvar": 2,
                        "forklaring": "Et rasjonalt tall kan skrives som en brøk med heltall. $\\frac{3}{4}$ er allerede en brøk."
                    },
                    {
                        "sporsmal": "Er tallet 5 et naturlig tall?",
                        "alternativer": [
                            "Ja",
                            "Nei"
                        ],
                        "riktigSvar": 0,
                        "forklaring": "Naturlige tall ($\\mathbb{N}$) er de positive heltallene $1, 2, 3, 4, 5...$"
                    }
                ]
            },
            {
                ...
                "oppgaver": [
                    {
                        ...
                        "fasit": "<strong>a)</strong><br>Tegn $x$-akse (horisontal) og $y$-akse (vertikal). Kryss origo.<br><br><strong>b)</strong><br>1. kvadrant $(+, +)$, 2. kvadrant $(-, +)$, 3. kvadrant $(-, -)$, 4. kvadrant $(+, -)$. Plott punktene.<br><br><strong>c)</strong><br>Marker punktet $(-1, -1)$ ved å gå 1 enhet til venstre og 1 ned fra origo. Marker $(1, 2)$ ved å gå 1 enhet til høyre og 2 opp.<br><br><strong>d)</strong><br>En rett linje representerer grafen til en lineær funksjon.<br><br><strong>Svar:</strong> En rett linje.",
                        "fasitSteg": null
                    },
                    {
                        "id": "4.1",
                        ...
                        "fasit": "<strong>a)</strong><br>$D_f$ (definisjonsmengden) er alle gyldige $x$-verdier for en funksjon.<br>$V_f$ (verdimengden) er alle mulige $y$-verdier funksjonen kan gi.<br><br>La oss si vi har en funksjon som går fra $x = 0$ til $x = 5$, og hvor grafen stiger slik at $y$-verdiene varierer fra $0$ til $10$.<br>Da vil $D_f = [0, 5]$ og $V_f = [0, 10]$.<br><br><strong>Svar:</strong> $D_f$ gjelder $x$-aksen, $V_f$ gjelder $y$-aksen.<br><br><strong>b)</strong><br>Et nullpunkt er punktet eller punktene der grafen skjærer $x$-aksen.<br>Dette skjer når funksjonsverdien er null, altså når $y = 0$.<br><br><strong>Svar:</strong> Et nullpunkt er skjæring med $x$-aksen ($y = 0$).",
                        "fasitSteg": null
                    },
                    {
                        "id": "4.2",
                        ...
                        "fasit": "<strong>a)</strong><br>Vi skal finne eksakte verdier ved å sette inn $t = 2$ og $t = 5$ i uttrykket for $B(t)$.<br><br>For $t = 2$:<br>$B(2) = 2 \\cdot \\pi \\cdot 2^2$ (sett inn $t=2$)<br>$B(2) = 2 \\cdot \\pi \\cdot 4$ (regn ut potensen)<br>$B(2) = 8\\pi$ (multipliser tallene)<br><br>For $t = 5$:<br>$B(5) = 2 \\cdot \\pi \\cdot 5^2$ (sett inn $t=5$)<br>$B(5) = 2 \\cdot \\pi \\cdot 25$ (regn ut potensen)<br>$B(5) = 50\\pi$ (multipliser tallene)<br><br><strong>Svar:</strong> $B(2) = 8\\pi$ og $B(5) = 50\\pi$.<br><br><strong>b)</strong><br>Funksjonen $B(t) = 2 \\cdot \\pi \\cdot t^2$ stiger kontinuerlig når $t > 0$.<br>Definisjonsmengden er $D_B = [2, 5]$.<br>Siden funksjonen bare vokser i dette intervallet, vil den laveste verdien være ved $t = 2$ og den høyeste verdien ved $t = 5$.<br><br>Minste verdi: $8\\pi$<br>Største verdi: $50\\pi$<br><br><strong>Svar:</strong> Verdimengden er $V_B = [8\\pi, 50\\pi]$.",
                        "fasitSteg": null
                    },
                    {
                        "id": "4.3",
                        ...
                        "fasit": "<strong>a)</strong><br>Vi setter funksjonsuttrykket lik null for å finne nullpunktene:<br>$x^2 - 4x + 3 = 0$<br><br>Vi kan bruke abc-formelen, eller vi kan faktorisere ved å finne to tall som multiplisert gir $3$ og addert gir $-4$.<br>Disse tallene er $-1$ og $-3$.<br><br>$(x - 1)(x - 3) = 0$<br>$x - 1 = 0 \\Rightarrow x = 1$<br>$x - 3 = 0 \\Rightarrow x = 3$<br><br><strong>Svar:</strong> Nullpunktene er $x = 1$ og $x = 3$.<br><br><strong>b)</strong><br>Siden grafen er en parabel som \"smiler\" (positivt tall foran $x^2$), har den et bunnpunkt. Dette punktet utgjør den laveste verdien i verdimengden.<br>$x$-koordinaten til bunnpunktet ligger midt mellom nullpunktene:<br>$x = \\frac{1 + 3}{2} = 2$<br><br>Vi setter $x = 2$ inn i funksjonen for å finne den laveste $y$-verdien:<br>$g(2) = 2^2 - 4 \\cdot 2 + 3$<br>$g(2) = 4 - 8 + 3 = -1$<br><br>Bunnpunktet er på $y = -1$, og deretter stiger grafen uendelig oppover.<br><br><strong>Svar:</strong> Verdimengden er $V_g = [-1, \\rightarrow\\rangle$.<br><br><strong>c)</strong><br>Vi setter inn $x = 0$ direkte i funksjonen:<br><br>$g(0) = 0^2 - 4 \\cdot 0 + 3$<br>$g(0) = 3$<br><br><strong>Svar:</strong> $g(0) = 3$.<br><br><strong>d)</strong><br>Vi setter hele funksjonsuttrykket lik $3$:<br>$x^2 - 4x + 3 = 3$<br><br>Vi trekker fra $3$ på begge sider for å få $0$ på høyre side:<br>$x^2 - 4x = 0$<br><br>Vi faktoriserer ved å trekke ut felles faktor $x$:<br>$x(x - 4) = 0$<br><br>Dette gir oss to løsninger der ett av leddene må være null:<br>$x = 0$ eller $x - 4 = 0$<br><br><strong>Svar:</strong> $x = 0$ og $x = 4$.",
                        "fasitSteg": null
                    },
                    {
                        "id": "4.4",
                        ...
                        "fasit": "<strong>a)</strong><br>En funksjon er definert slik at det kun eksisterer én unik $y$-verdi for en gitt $x$-verdi.<br>Når vi setter inn $x = c$, vil vi derfor alltid kun få ett unikt svar.<br><br><strong>Svar:</strong> Nei, det kan kun finnes ett svar.<br><br><strong>b)</strong><br>Flere $x$-verdier kan gi samme $y$-verdi i en funksjon.<br>For eksempel, for en parabel $y = x^2$, vil $y = 4$ for både $x = 2$ og $x = -2$.<br>Derfor kan likningen $h(x) = d$ ha mer enn ett svar.<br><br><strong>Svar:</strong> Ja. Flere $x$-verdier kan gi den samme $y$-verdien (funksjonen kan bølge opp og ned).",
                        "fasitSteg": null
                    },
                    {
                        "id": "4.5",
                    ...
                    },
                    {
                        ...
                        "fasit": "<strong>a)</strong><br>Vi bytter ut $x$ med $k$ i hele uttrykket.<br><br>$g(k) = (k)^2 + 2(k) - 3$<br>$g(k) = k^2 + 2k - 3$<br><br><strong>Svar:</strong> $g(k) = k^2 + 2k - 3$.<br><br><strong>b)</strong><br>Vi bytter ut $x$ med $2k$ i hele uttrykket. Pass på å bruke parenteser!<br><br>$g(2k) = (2k)^2 + 2(2k) - 3$ (setter inn $2k$)<br>$g(2k) = 4k^2 + 4k - 3$ (regner ut potensen og gangingen)<br><br><strong>Svar:</strong> $g(2k) = 4k^2 + 4k - 3$.<br><br><strong>c)</strong><br>Vi bytter ut $x$ med $(k-1)$ i hele uttrykket.<br><br>$g(k-1) = (k-1)^2 + 2(k-1) - 3$ (setter inn $k-1$)<br>$g(k-1) = (k^2 - 2k + 1) + 2k - 2 - 3$ (bruker 2. kvadratsetning på første parentes, og ganger ut andre)<br>$g(k-1) = k^2 - 2k + 2k + 1 - 2 - 3$ (sorterer leddene)<br>$g(k-1) = k^2 - 4$ (trekker sammen)<br><br><strong>Svar:</strong> $g(k-1) = k^2 - 4$.",
                        "fasitSteg": null
                    },
                    {
                        "id": "4.7",
                        ...
                        "fasit": "<strong>a)</strong><br>Vi vet at grafen til $g$ går gjennom punktet $(2, 5)$. Det betyr at når $x = 2$, er $y = 5$, altså at $g(2) = 5$.<br>Vi setter dette inn i uttrykket for $g(x)$:<br><br>$g(2) = 2 \\cdot 2 + b = 5$ (setter inn $x=2$)<br>$4 + b = 5$ (regner ut produktet)<br>$b = 5 - 4$ (flytter 4 til høyre side og skifter fortegn)<br>$b = 1$<br><br>Vi har allerede $f(x)$ oppgitt. Nå som vi kjenner $b$, vet vi også $g(x)$.<br><br><strong>Svar:</strong> $f(x) = 0.5x^2 + 3x - 3$ og $g(x) = 2x + 1$.<br><br><strong>b)</strong><br>For å finne skjæringspunkt, setter vi funksjonene lik hverandre fordi de har samme $x$- og $y$-verdi der de krysser:<br>$f(x) = g(x)$<br><br>$0.5x^2 + 3x - 3 = 2x + 1$<br>$0.5x^2 + 3x - 2x - 3 - 1 = 0$ (flytter alt til venstre side)<br>$0.5x^2 + x - 4 = 0$ (trekker sammen leddene)<br><br>For å gjøre utregningen lettere, kan vi gange hele likningen med $2$:<br>$x^2 + 2x - 8 = 0$<br><br>Vi kan bruke abc-formelen, eller faktorisere ved å finne to tall som multiplisert gir $-8$ og addert gir $2$. Tallene er $4$ og $-2$.<br>$(x + 4)(x - 2) = 0$<br><br>Dette gir løsningene $x = -4$ og $x = 2$.<br>Vi kjenner allerede punktet der $x = 2$, så vi må finne $y$-verdien når $x = -4$.<br>Vi kan sette $x = -4$ inn i en av funksjonene (velger $g(x)$ siden den er enklest):<br>$g(-4) = 2 \\cdot (-4) + 1 = -8 + 1 = -7$.<br><br><strong>Svar:</strong> Det andre skjæringspunktet er $(-4, -7)$.<br><br><strong>c)</strong><br>Vi tester om punktet $(1, 4)$ ligger på noen av grafene ved å sette inn $x = 1$ og sjekke om vi får ut $y = 4$.<br><br>For $f(x)$:<br>$f(1) = 0.5 \\cdot 1^2 + 3 \\cdot 1 - 3$<br>$f(1) = 0.5 + 3 - 3 = 0.5 \\ne 4$<br><br>For $g(x)$:<br>$g(1) = 2 \\cdot 1 + 1$<br>$g(1) = 3 \\ne 4$<br><br><strong>Svar:</strong> Nei, punktet $(1, 4)$ ligger ikke på noen av grafene.",
                        "fasitSteg": null
                    }
                ],
                "quiz": null
                ...
                "oppgaver": [
                    {
                        ...
                        "fasit": "<strong>a)</strong><br>En lineær funksjon danner alltid en rett linje når vi tegner den i et koordinatsystem. For å løse oppgaven tegner du et todimensjonalt koordinatsystem (med en $x$-akse og en $y$-akse) og trekker en vilkårlig rett linje med en linjal.<br><br><strong>b)</strong><br>Alle lineære funksjoner kan skrives på en generell form.<br><br>$f(x) = ax + b$<br><br>Her representerer $a$ stigningstallet, som forteller oss hvor mye grafen stiger eller synker for hver enhet vi går til høyre på $x$-aksen.<br>Bokstaven $b$ er konstantleddet, og dette forteller oss hvor grafen skjærer $y$-aksen (altså når $x = 0$).<br><br><strong>Svar:</strong> Formen er $f(x) = ax + b$, der $a$ er stigningstallet og $b$ er konstantleddet.",
                        "fasitSteg": null
                    },
                    {
                        "id": "4.9",
                    ...
                    },
                    {
                        ...
                        "fasit": "<strong>a)</strong><br>En lineær funksjon har formen $h(x) = ax + b$.<br><br>Først finner vi stigningstallet $a$ ved hjelp av topunktsformelen:<br>$a = \\frac{y_2 - y_1}{x_2 - x_1}$<br><br>Vi setter inn koordinatene for de to punktene $(1, 5)$ og $(4, -1)$:<br>$a = \\frac{-1 - 5}{4 - 1}$ (finner endringene i telleren og nevneren)<br>$a = \\frac{-6}{3}$<br>$a = -2$<br><br>Nå vet vi at funksjonen ser slik ut: $h(x) = -2x + b$. Vi finner konstantleddet $b$ ved å sette inn ett av punktene, for eksempel $(1, 5)$:<br>$5 = -2 \\cdot 1 + b$ (setter inn $x = 1$ og $y = 5$)<br>$5 = -2 + b$<br>$b = 5 + 2$ (flytter $-2$ over likhetstegnet)<br>$b = 7$<br><br><strong>Svar:</strong> $h(x) = -2x + 7$<br><br><strong>b)</strong><br>For å sjekke om et bestemt punkt ligger på grafen, setter vi punktets $x$-verdi inn i funksjonen og ser om vi får punktets $y$-verdi som svar.<br><br>Vi setter inn $x = 3$:<br>$h(3) = -2 \\cdot 3 + 7$<br>$h(3) = -6 + 7$<br>$h(3) = 1$<br><br>Vi fikk $y = 1$, noe som stemmer perfekt med punktet $(3, 1)$.<br><br><strong>Svar:</strong> Ja, punktet $(3, 1)$ ligger på grafen.<br><br><strong>c)</strong><br>Nullpunktet til en funksjon er den $x$-verdien der grafen skjærer $x$-aksen. På $x$-aksen er $y = 0$, så vi må løse likningen $h(x) = 0$.<br><br>$-2x + 7 = 0$<br>$7 = 2x$ (flytter $-2x$ til høyre side for å få positivt fortegn)<br>$x = \\frac{7}{2}$ (deler på $2$)<br>$x = 3.5$<br><br><strong>Svar:</strong> Nullpunktet er $x = 3.5$",
                        "fasitSteg": null
                    },
                    {
                        "id": "4.11",
                    ...
                    },
                    {
                        ...
                        "fasit": "<strong>a)</strong><br>Vi finner skjæringspunktet med $y$-aksen ved å sette $x = 0$:<br>$15 \\cdot 0 + 45y = 900$<br>$45y = 900$<br>$y = \\frac{900}{45}$<br>$y = 20$<br>Grafen skjærer altså $y$-aksen i punktet $(0, 20)$.<br><br>Vi finner skjæringspunktet med $x$-aksen ved å sette $y = 0$:<br>$15x + 45 \\cdot 0 = 900$<br>$15x = 900$<br>$x = \\frac{900}{15}$<br>$x = 60$<br>Grafen skjærer altså $x$-aksen i punktet $(60, 0)$.<br><br><strong>Svar:</strong> Skjæringspunktene med aksene er $(0, 20)$ og $(60, 0)$.<br><br><strong>b)</strong><br>For å skissere linjen i et koordinatsystem, trenger du bare de to punktene vi fant i oppgave a. Plasser punktet $(0, 20)$ på $y$-aksen, og plasser punktet $(60, 0)$ på $x$-aksen. Bruk deretter en linjal for å trekke en rett linje gjennom disse to punktene.<br><br><strong>Svar:</strong> Trekk linjen mellom punktene $(0, 20)$ og $(60, 0)$.",
                        "fasitSteg": null
                    },
                    {
                        "id": "4.13",
                    ...
                    },
                    {
                        ...
                        "fasit": "<strong>a)</strong><br>Vi starter med å finne uttrykket for $f(x) = a_f x + b_f$:<br>Linjen går gjennom $(0, 2)$, noe som betyr at konstantleddet $b_f$ er $2$.<br>Vi finner stigningstallet $a_f$ ved å bruke topunktsformelen med de to oppgitte punktene:<br>$a_f = \\frac{6 - 2}{4 - 0} = \\frac{4}{4} = 1$<br>Dette gir oss funksjonen $f(x) = 1x + 2$, altså $f(x) = x + 2$.<br><br>Så finner vi uttrykket for $g(x) = a_g x + b_g$:<br>Linjen går gjennom $(0, 5)$, noe som betyr at konstantleddet $b_g$ er $5$.<br>Vi regner ut stigningstallet $a_g$ med de to oppgitte punktene:<br>$a_g = \\frac{0 - 5}{5 - 0} = \\frac{-5}{5} = -1$<br>Dette gir oss funksjonen $g(x) = -1x + 5$, altså $g(x) = -x + 5$.<br><br><strong>Svar:</strong> $f(x) = x + 2$ og $g(x) = -x + 5$<br><br><strong>b)</strong><br>Vi setter funksjonsuttrykkene lik hverandre for å løse likningen $f(x) = g(x)$.<br><br>$x + 2 = -x + 5$<br><br>Vi samler $x$-ene på venstre side og tallene på høyre side:<br>$x + x = 5 - 2$<br><br>Vi slår sammen:<br>$2x = 3$<br><br>Vi deler på $2$ for å få $x$ alene:<br>$x = \\frac{3}{2} = 1.5$<br><br><strong>Svar:</strong> $x = 1.5$",
                        "fasitSteg": null
                    },
                    {
                        "id": "4.16",
                ...
                "oppgaver": [
                    {
                        ...
                        "fasit": "Polynomfunksjoner skrives generelt på formen:<br><br>$f(x) = a_n x^n + a_{n-1} x^{n-1} + \\dots + a_1 x + a_0$<br><br>hvor $n$ er graden til polynomet, og $a_n, a_{n-1}, \\dots, a_0$ er koeffisienter (tall).<br><br>Vi kan lage egne eksempler for ulike grader ved å velge en høyeste eksponent.<br><br>For en andregradsfunksjon må høyeste eksponent være $2$:<br>$f(x) = x^2$<br><br>For en tredjegradsfunksjon må høyeste eksponent være $3$:<br>$f(x) = x^3 - x$<br><br>For en fjerdegradsfunksjon må høyeste eksponent være $4$:<br>$f(x) = x^4 - 1$<br><br><strong>Svar:</strong> Generell form er $f(x) = a_n x^n + \\dots + a_0$. Eksempler kan være $f(x) = x^2$, $f(x) = x^3 - x$ og $f(x) = x^4 - 1$.",
                        "fasitSteg": null
                    },
                    {
                        "id": "4.18",
                        ...
                        "fasit": "<strong>a)</strong><br>Grafen til $T(t)$ er en parabel. Siden koeffisienten foran $t^2$ er negativ ($-0.2$), vender den hulerommet nedover (en \"sur\" parabel). Man kan tegne denne for hånd ved å lage en verditabell eller bruke et digitalt verktøy (f.eks. GeoGebra).<br><br><strong>Svar:</strong> Grafen er en parabel som vender nedover.<br><br><strong>b)</strong><br>Vi skal finne tidspunktet $t$ når temperaturen er høyest. Dette tilsvarer toppunktet til parabelen.<br>Vi bruker formelen for symmetriaksen:<br>$t = \\frac{-b}{2a}$<br><br>Setter inn verdiene for $a = -0.2$ og $b = 5.2$:<br>$t = \\frac{-5.2}{2 \\cdot (-0.2)}$<br><br>$t = \\frac{-5.2}{-0.4}$<br><br>$t = 13$<br><br>Siden kl. 08:00 tilsvarer $t=8$, vil $t=13$ tilsvare kl. 13:00.<br><br>Vi finner også temperaturen på dette tidspunktet ved å sette inn $t = 13$ i funksjonen:<br>$T(13) = -0.2 \\cdot 13^2 + 5.2 \\cdot 13 - 18.8$<br><br>$T(13) = -0.2 \\cdot 169 + 67.6 - 18.8$<br><br>$T(13) = -33.8 + 67.6 - 18.8$<br><br>$T(13) = 15$<br><br><strong>Svar:</strong> Temperaturen var høyest kl. 13:00, og da var den $15.0^{\\circ}C$.<br><br><strong>c)</strong><br>Vi skal finne temperaturen kl. 08:00, som tilsvarer $t=8$:<br>$T(8) = -0.2 \\cdot 8^2 + 5.2 \\cdot 8 - 18.8$<br><br>$T(8) = -0.2 \\cdot 64 + 41.6 - 18.8$<br><br>$T(8) = -12.8 + 41.6 - 18.8$<br><br>$T(8) = 10.0$<br><br>Vi skal finne temperaturen kl. 15:00, som tilsvarer $t=15$:<br>$T(15) = -0.2 \\cdot 15^2 + 5.2 \\cdot 15 - 18.8$<br><br>$T(15) = -0.2 \\cdot 225 + 78.0 - 18.8$<br><br>$T(15) = -45.0 + 78.0 - 18.8$<br><br>$T(15) = 14.2$<br><br><strong>Svar:</strong> Temperaturen var $10.0^{\\circ}C$ kl. 08:00 og $14.2^{\\circ}C$ kl. 15:00.",
                        "fasitSteg": null
                    },
                    {
                        "id": "4.19",
                        ...
                        "fasit": "<strong>a)</strong><br>I et koordinatsystem er førsteaksen x-aksen, og andreaksen er y-aksen.<br><br><strong>Svar:</strong> Andreaksen er y-aksen.<br><br><strong>b)</strong><br>Grafen skjærer andreaksen (y-aksen) der hvor x-verdien er lik $0$.<br>Vi setter $x = 0$ inn i funksjonen:<br><br>$g(0) = 0^2 + 6 \\cdot 0 + 5$<br><br>$g(0) = 5$<br><br>Dette gir oss et punkt med koordinatene $(0, 5)$.<br><br><strong>Svar:</strong> Grafen skjærer andreaksen i punktet $(0, 5)$.<br><br><strong>c)</strong><br>Nullpunktene er de punktene der grafen skjærer x-aksen, det vil si der $g(x) = 0$.<br>Vi setter opp likningen:<br><br>$x^2 + 6x + 5 = 0$<br><br>Vi kan løse dette ved hjelp av abc-formelen, der $a=1$, $b=6$ og $c=5$:<br><br>$x = \\frac{-b \\pm \\sqrt{b^2 - 4ac}}{2a}$<br><br>$x = \\frac{-6 \\pm \\sqrt{6^2 - 4 \\cdot 1 \\cdot 5}}{2 \\cdot 1}$<br><br>$x = \\frac{-6 \\pm \\sqrt{36 - 20}}{2}$<br><br>$x = \\frac{-6 \\pm \\sqrt{16}}{2}$<br><br>$x = \\frac{-6 \\pm 4}{2}$<br><br>Dette gir to løsninger:<br>$x = \\frac{-6 + 4}{2} = \\frac{-2}{2} = -1$<br>og<br>$x = \\frac{-6 - 4}{2} = \\frac{-10}{2} = -5$<br><br><strong>Svar:</strong> Nullpunktene er $x = -1$ og $x = -5$.<br><br><strong>d)</strong><br>Funksjonen er et andregradspolynom, $g(x) = ax^2 + bx + c$.<br>Siden koeffisienten foran $x^2$ er positiv ($a = 1 > 0$), vender grafen hulerommet oppover (den \"smiler\").<br>Dette betyr at grafen har et absolutt minimum, altså et bunnpunkt.<br><br><strong>Svar:</strong> Funksjonen har et bunnpunkt.<br><br><strong>e)</strong><br>x-koordinaten til ekstremalpunktet (bunnpunktet) finner vi på symmetriaksen:<br>$x = \\frac{-b}{2a}$<br><br>Setter inn $a=1$ og $b=6$:<br>$x = \\frac{-6}{2 \\cdot 1} = -3$<br><br>For å finne y-koordinaten, setter vi $x = -3$ inn i funksjonen:<br>$g(-3) = (-3)^2 + 6 \\cdot (-3) + 5$<br><br>$g(-3) = 9 - 18 + 5$<br><br>$g(-3) = -4$<br><br>Punktet har dermed koordinatene $(-3, -4)$.<br><br><strong>Svar:</strong> Ekstremalpunktet er bunnpunktet $(-3, -4)$.",
                        "fasitSteg": null
                    },
                    {
                        "id": "4.20",
                        ...
                        "fasit": "<strong>a)</strong><br>Når vi vet nullpunktene til et polynom, kan vi skrive det på faktorisert form. <br>Nullpunktene er $x_1 = -2$, $x_2 = 1$ og $x_3 = 3$.<br><br>Den generelle formen er:<br>$h(x) = a(x - x_1)(x - x_2)(x - x_3)$<br><br>Vi setter inn nullpunktene:<br>$h(x) = a(x - (-2))(x - 1)(x - 3)$<br><br>$h(x) = a(x + 2)(x - 1)(x - 3)$<br><br><strong>Svar:</strong> Funksjonsuttrykket på faktorisert form er $h(x) = a(x + 2)(x - 1)(x - 3)$.<br><br><strong>b)</strong><br>Vi får oppgitt punktet $(0, 12)$, som betyr at $h(0) = 12$. <br>Vi setter $x = 0$ inn i den faktoriserte formen vi fant i oppgave a, og løser for $a$:<br><br>$h(0) = a(0 + 2)(0 - 1)(0 - 3)$<br><br>$12 = a \\cdot 2 \\cdot (-1) \\cdot (-3)$ (regner ut parentesene)<br><br>$12 = a \\cdot 6$ (forenkler)<br><br>$6a = 12$<br><br>$a = \\frac{12}{6}$<br><br>$a = 2$<br><br><strong>Svar:</strong> $a = 2$.<br><br><strong>c)</strong><br>Vi vet nå at $a = 2$, så funksjonsuttrykket på faktorisert form er:<br>$h(x) = 2(x + 2)(x - 1)(x - 3)$<br><br>For å finne det fullstendige uttrykket, må vi gange ut parentesene. <br>Vi starter med å gange sammen de to siste parentesene:<br>$(x - 1)(x - 3) = x^2 - 3x - 1x + 3 = x^2 - 4x + 3$<br><br>Nå setter vi dette inn igjen i uttrykket:<br>$h(x) = 2(x + 2)(x^2 - 4x + 3)$<br><br>Deretter ganger vi inn $(x + 2)$:<br>$(x + 2)(x^2 - 4x + 3)$<br>$= x \\cdot x^2 + x \\cdot (-4x) + x \\cdot 3 + 2 \\cdot x^2 + 2 \\cdot (-4x) + 2 \\cdot 3$<br>$= x^3 - 4x^2 + 3x + 2x^2 - 8x + 6$<br>$= x^3 - 2x^2 - 5x + 6$<br><br>Til slutt må vi huske å gange hele uttrykket med konstanten foran ($2$):<br>$h(x) = 2(x^3 - 2x^2 - 5x + 6)$<br><br>$h(x) = 2x^3 - 4x^2 - 10x + 12$<br><br><strong>Svar:</strong> Det fullstendige uttrykket er $h(x) = 2x^3 - 4x^2 - 10x + 12$.",
                        "fasitSteg": null
                    },
                    {
                        "id": "4.21",
                        ...
                        "fasit": "Først bruker vi polynomdivisjon. Vi deler polynomet på $(x - 3)$:<br><br>$(2x^3 - 10x^2 + 14x - 6) : (x - 3) = 2x^2 - 4x + 2$<br>$-(2x^3 - 6x^2)$<br>$\\dots$<br>$-4x^2 + 14x$<br>$-(-4x^2 + 12x)$<br>$\\dots$<br>$2x - 6$<br>$-(2x - 6)$<br>$\\dots$<br>$0$<br><br>Dette gir oss at $P(x)$ kan skrives som:<br>$P(x) = (x - 3)(2x^2 - 4x + 2)$<br><br>Nå må vi faktorisere andregradspolynomet $2x^2 - 4x + 2$.<br>Vi ser at alle leddene har faktoren $2$, så vi setter den utenfor en parentes:<br>$2x^2 - 4x + 2 = 2(x^2 - 2x + 1)$<br><br>Uttrykket inne i parentesen er gjenkjennelig som et fullstendig kvadrat.<br>Vi bruker andre kvadratsetning baklengs ($a^2 - 2ab + b^2 = (a-b)^2$):<br>$x^2 - 2x + 1 = (x - 1)^2$<br><br>Setter vi alt sammen, får vi:<br>$2x^2 - 4x + 2 = 2(x - 1)^2$<br><br>Vi setter dette inn i det opprinnelige uttrykket for å få fullstendig faktorisert form:<br>$P(x) = (x - 3) \\cdot 2(x - 1)^2$<br><br>Det er vanlig å skrive tallet først:<br>$P(x) = 2(x - 3)(x - 1)^2$<br><br><strong>Svar:</strong> Fullstendig faktorisert form er $P(x) = 2(x - 3)(x - 1)^2$.",
                        "fasitSteg": null
                    },
                    {
                        "id": "4.22",
                ...
                "oppgaver": [
                    {
                        ...
                        "fasit": "En rasjonal funksjon kan skrives som en brøk der teller og nevner er polynomer. <br><br>Et eksempel på dette er:<br><br>$f(x) = \\frac{1}{x}$<br><br>(Denne funksjonen illustreres som en hyperbel)<br><br><strong>Svar:</strong> En rasjonal funksjon er en brøk av polynomer, for eksempel $f(x) = \\frac{1}{x}$.",
                        "fasitSteg": null
                    },
                    {
                        "id": "4.24",
                        ...
                        "fasit": "En asymptote er en rett linje som grafen til en funksjon nærmer seg uendelig mye uten noen gang å berøre.<br><br>Vi har to hovedtyper (i tillegg til skrå asymptote):<br><br><strong>1) Loddrett asymptote:</strong> <br>Oppstår når nevneren går mot $0$. Grafen stuper opp eller ned langs linjen.<br><br><strong>2) Vannrett asymptote:</strong> <br>Viser hvilken verdi grafen flater ut på for svært store eller små verdier av $x$.<br><br><strong>Svar:</strong> En asymptote er en linje grafen nærmer seg uten å treffe. Hovedtypene er loddrett (nevner mot $0$) og vannrett (verdien grafen flater ut på).",
                        "fasitSteg": null
                    },
                    {
                        "id": "4.25",
                    ...
                    },
                    {
                        ...
                        "fasit": "<strong>a)</strong><br>Nullpunkt finner vi når telleren er lik $0$:<br>$3x - 6 = 0$<br>$3x = 6$<br>$x = 2$<br><br>For y-skjæring setter vi inn $x = 0$:<br>$k(0) = \\frac{3 \\cdot 0 - 6}{0 + 2} = \\frac{-6}{2} = -3$<br><br><strong>Svar:</strong> Nullpunkt er $x = 2$. y-skjæringen er i punktet $(0, -3)$.<br><br><strong>b)</strong><br>Loddrett asymptote finner vi når nevneren er $0$:<br>$x + 2 = 0$<br>$x = -2$<br><br>Vannrett asymptote finner vi ved å se på leddene med høyest grad:<br>$\\frac{3x}{x} = 3$<br>$y = 3$<br><br><strong>Svar:</strong> Loddrett asymptote er $x = -2$ og vannrett asymptote er $y = 3$.<br><br><strong>c)</strong><br>Definisjonsmengden er alle mulige $x$-verdier. Siden vi ikke kan dele på $0$, må $x <br>eq -2$:<br>$D_k = \\mathbb{R} \\setminus \\{-2\\}$<br><br>Verdimengden er alle mulige $y$-verdier. Grafen vil aldri treffe den vannrette asymptoten $y = 3$:<br>$V_k = \\mathbb{R} \\setminus \\{3\\}$<br><br><strong>Svar:</strong> $D_k = \\mathbb{R} \\setminus \\{-2\\}$ og $V_k = \\mathbb{R} \\setminus \\{3\\}$.<br><br><strong>d)</strong><br>Tegn asymptotene som stiplede linjer i et koordinatsystem:<br>- Loddrett linje i $x = -2$<br>- Vannrett linje i $y = 3$<br><br>Marker punktene fra oppgave a: $(2, 0)$ og $(0, -3)$.<br>Tegn kurvene i hjørnene slik at de går gjennom punktene og legger seg inntil asymptotene.<br><br><strong>Svar:</strong> Grafen skisseres med asymptotene $x = -2$ og $y = 3$.",
                        "fasitSteg": null
                    },
                    {
                        "id": "4.27",
                        ...
                        "fasit": "Fra grafen kan vi lese av to viktige egenskaper:<br><br>Loddrett asymptote i $x = 1$. Det betyr at nevneren må bli $0$ når $x = 1$.<br>$x - 1 = 0$ (dette betyr at nevneren må inneholde $x - 1$)<br><br>Nullpunkt i $x = -2$. Det betyr at telleren må bli $0$ når $x = -2$.<br>$x + 2 = 0$ (dette betyr at telleren må inneholde $x + 2$)<br><br>Vi ser på alternativene og finner det uttrykket som har teller $x+2$ og nevner $x-1$.<br>Dette stemmer med alternativ 4:<br>$f(x) = \\frac{x+2}{x-1}$<br><br><strong>Svar:</strong> Alternativ 4 er riktig uttrykk: $f(x) = \\frac{x+2}{x-1}$.",
                        "fasitSteg": null
                    },
                    {
                        "id": "4.28",
                        ...
                        "fasit": "<strong>a)</strong><br>Nullpunkt finner vi når telleren er lik $0$:<br>$2x^2 - x - 3 = 0$<br><br>Vi bruker abc-formelen:<br>$x = \\frac{-(-1) \\pm \\sqrt{(-1)^2 - 4 \\cdot 2 \\cdot (-3)}}{2 \\cdot 2}$<br>$x = \\frac{1 \\pm \\sqrt{1 + 24}}{4}$<br>$x = \\frac{1 \\pm 5}{4}$<br>Dette gir to løsninger: $x = 1.5$ og $x = -1$.<br><br>For y-skjæring setter vi inn $x = 0$:<br>$r(0) = \\frac{2 \\cdot 0^2 - 0 - 3}{0 - 1} = \\frac{-3}{-1} = 3$<br><br><strong>Svar:</strong> Nullpunktene er $x = 1.5$ og $x = -1$. y-skjæringen er $y = 3$.<br><br><strong>b)</strong><br>Loddrett asymptote finner vi når nevneren er $0$:<br>$x - 1 = 0$<br>$x = 1$<br><br><strong>Svar:</strong> Loddrett asymptote er $x = 1$.<br><br><strong>c)</strong><br>Vi utfører polynomdivisjonen $(2x^2 - x - 3) : (x - 1)$:<br><br>$(2x^2 - x - 3) : (x - 1) = 2x + 1$<br>$-(2x^2 - 2x)$<br>$\\rightarrow x - 3$<br>$-(x - 1)$<br>$\\rightarrow -2$ (dette er resten)<br><br>Vi kan dermed skrive om funksjonen på formen:<br>$r(x) = 2x + 1 - \\frac{2}{x - 1}$<br><br>Når $x$ blir uendelig stor (eller liten), vil brøken $-\\frac{2}{x - 1}$ gå mot $0$. Da vil grafen nærme seg linjen $y = 2x + 1$.<br><br><strong>Svar:</strong> Polynomdivisjon gir at $r(x) = 2x + 1 - \\frac{2}{x - 1}$, og dermed er $y = 2x + 1$ en skrå asymptote.<br><br><strong>d)</strong><br>For å ha en vannrett asymptote, må teller og nevner ha samme grad, eller nevner må ha høyere grad enn teller.<br>Her har telleren grad 2 ($x^2$) og nevneren grad 1 ($x$). Telleren vil derfor vokse mye raskere enn nevneren når $x$ går mot uendelig.<br><br><strong>Svar:</strong> Nei, funksjonen har ikke en vannrett asymptote fordi telleren har høyere grad enn nevneren.",
                        "fasitSteg": null
                    },
                    {
                        "id": "4.29",
                    ...
                    },
                    {
                        ...
                        "fasit": "<strong>a)</strong><br>Vi utfører polynomdivisjonen $(x^4 - x^3 + 2x^2 - x + 3) : (x^2 + 1)$:<br><br>$(x^4 - x^3 + 2x^2 - x + 3) : (x^2 + 1) = x^2 - x + 1$<br>$-(x^4 + x^2)$<br>$\\rightarrow -x^3 + x^2 - x + 3$<br>$-(-x^3 - x)$<br>$\\rightarrow x^2 + 3$<br>$-(x^2 + 1)$<br>$\\rightarrow 2$ (dette er resten)<br><br><strong>Svar:</strong> Resultatet av polynomdivisjonen er $x^2 - x + 1$ med rest $2$.<br><br><strong>b)</strong><br>Vi kan nå skrive funksjonen på rest-form (svar fra divisjon + brøk med rest og nevner):<br>$P(x) = (x^2 - x + 1) + \\frac{2}{x^2 + 1}$<br><br>For svært store (eller svært små negative) verdier av $x$ vil verdien av nevneren i restbrøken ($x^2 + 1$) bli enormt stor.<br>Dermed vil verdien av brøken nærme seg $0$:<br>$\\frac{2}{\\text{stort tall}} \\rightarrow 0$<br><br>Når brøken forsvinner mot $0$, vil grafen til $P(x)$ legge seg nærmere og nærmere grafen til andregradspolynomet.<br><br><strong>Svar:</strong> På rest-form kan funksjonen skrives som $P(x) = x^2 - x + 1 + \\frac{2}{x^2 + 1}$. For store verdier av $x$ vil brøken gå mot $0$, og funksjonen vil oppføre seg som parabelen $y = x^2 - x + 1$.",
                        "fasitSteg": null
                    }
                ],
                "quiz": null
                ...
                "oppgaver": [
                    {
                        ...
                        "fasit": "<strong>a)</strong><br>Vi definerer den generelle formen for en potensfunksjon.<br><br>$f(x) = a \\cdot x^b$<br><br>Her er $a$ en skaleringsfaktor, $x$ er en variabel i grunntallet, og $b$ er en fast eksponent.<br><br><strong>Svar:</strong> Formen er $f(x) = a \\cdot x^b$.<br><br><strong>b)</strong><br>Potensfunksjoner er hensiktsmessige å bruke når vi har sammenhenger der den relative veksten avhenger av grunnverdien.<br><br>Dette brukes typisk i fysikk og geometri. Et eksempel er sammenhengen mellom radius og areal eller volum.<br><br><strong>Svar:</strong> De brukes typisk i fysikk og geometri (f.eks. areal og volum).",
                        "fasitSteg": null
                    },
                    {
                        "id": "4.32",
                        ...
                        "fasit": "<strong>a)</strong><br>Vi setter inn verdien $V = 10$ i uttrykket og løser for $t$.<br><br>$2.5 \\cdot t^{0.6} = 10$<br><br>$t^{0.6} = \\frac{10}{2.5}$ (del på 2.5)<br><br>$t^{0.6} = 4$ (forenkle)<br><br>$t = 4^{\\frac{1}{0.6}}$ (opphøy begge sider i $\\frac{1}{0.6}$)<br><br>$t \\approx 10.1$ uker<br><br><strong>Svar:</strong> Tiden det tar før volumet er $10 \\text{ cm}^3$ er ca $10.1$ uker.<br><br><strong>b)</strong><br>Vi skal finne den prosentvise veksten fra $t = 3$ til $t = 4$.<br><br>$V(4) = 2.5 \\cdot 4^{0.6} \\approx 5.74$ (regn ut volumet ved uke 4)<br><br>$V(3) = 2.5 \\cdot 3^{0.6} \\approx 4.83$ (regn ut volumet ved uke 3)<br><br>Vi finner vekstfaktoren ved å dele:<br><br>$\\frac{V(4)}{V(3)} = \\frac{5.74}{4.83} \\approx 1.188$<br><br>Dette gir en vekstfaktor på $1.188$, som tilsvarer en økning på $18.8\\%$.<br><br><strong>Svar:</strong> Volumet vokser med $18.8\\%$.",
                        "fasitSteg": null
                    },
                    {
                        "id": "4.33",
                        ...
                        "fasit": "<strong>a)</strong><br>Kurven er en voksende funksjon med en avtagende veksthastighet.<br><br>Når $m=1000$: $T(1000) = 1.2 \\cdot 1000^{0.55} \\approx 53.8$ minutter.<br><br>Når $m=3000$: $T(3000) = 1.2 \\cdot 3000^{0.55} \\approx 98.4$ minutter.<br><br><strong>Svar:</strong> Kurven vokser gradvis fra $53.8$ til $98.4$.<br><br><strong>b)</strong><br>Vi regner ut steketiden for $m = 2000$.<br><br>$T(2000) = 1.2 \\cdot 2000^{0.55}$ (sett inn $2000$ for $m$)<br><br>$T(2000) \\approx 78.7$ minutter<br><br><strong>Svar:</strong> Steketiden er $78.7$ minutter.<br><br><strong>c)</strong><br>Vi regner først ut steketiden for $m = 2500$.<br><br>$T(2500) = 1.2 \\cdot 2500^{0.55} \\approx 89.0$ minutter (sett inn $2500$ for $m$)<br><br>Vi finner deretter differansen fra steketiden i b):<br><br>Forskjell $= T(2500) - T(2000) = 89.0 - 78.7 = 10.3$ minutter<br><br><strong>Svar:</strong> Forskjellen i steketid er $10.3$ minutter.",
                        "fasitSteg": null
                    },
                    {
                        "id": "4.34",
                    ...
                    },
                    {
                        ...
                        "fasit": "<strong>a)</strong><br>Vi setter $x = 5$ inn i formelen.<br><br>$A(5) = 3.14 \\cdot 5^{1.9}$<br><br>$A(5) \\approx 66.8$ (regn ut produktet)<br><br><strong>Svar:</strong> Arealet er $66.8 \\text{ km}^2$.<br><br><strong>b)</strong><br>Vi setter $A(x) = 100$ inn i ligningen og løser for $x$.<br><br>$3.14 \\cdot x^{1.9} = 100$<br><br>$x^{1.9} = \\frac{100}{3.14}$ (del begge sider på $3.14$)<br><br>$x = \\left(\\frac{100}{3.14}\\right)^{\\frac{1}{1.9}}$ (opphøy i invers brøk)<br><br>$x \\approx 6.13 \\text{ km}$<br><br><strong>Svar:</strong> Radiusen er $6.13 \\text{ km}$.<br><br><strong>c)</strong><br>Når radiusen $x$ øker med $15\\%$, multipliseres den med vekstfaktoren $1.15$.<br>Siden arealet er proporsjonalt med $x^{1.9}$, må vekstfaktoren for arealet være $1.15^{1.9}$.<br><br>Vekstfaktor $= 1.15^{1.9} \\approx 1.304$<br><br>Dette gir en økning på $30.4\\%$.<br><br><strong>Svar:</strong> Arealet øker med $30.4\\%$.",
                        "fasitSteg": null
                    },
                    {
                        "id": "4.36",
                        ...
                        "fasit": "<strong>a)</strong><br>Vi setter inn $x = 500$ i funksjonen.<br><br>$C(500) = 150 \\cdot 500^{-0.15}$<br><br>$C(500) \\approx 57$ (regn ut produktet)<br><br><strong>Svar:</strong> Kapasiteten er ca $57\\%$.<br><br><strong>b)</strong><br>Kapasiteten er en avtagende funksjon fordi eksponenten er negativ ($-0.15$).<br><br>$C(x) = 150 \\cdot x^{-0.15}$<br><br>Kurven synker raskt til å begynne med, men flater gradvis ut for høyere verdier av ladesykluser.<br><br><strong>Svar:</strong> Det er en synkende kurve som gradvis flater ut.<br><br><strong>c)</strong><br>Vi setter kapasiteten $C(x) = 60$ og løser for antall ladesykluser $x$.<br><br>$150 \\cdot x^{-0.15} = 60$<br><br>$x^{-0.15} = \\frac{60}{150}$ (del på 150)<br><br>$x^{-0.15} = 0.4$ (forenkle)<br><br>$x = 0.4^{\\frac{1}{-0.15}}$ (opphøy begge sider)<br><br>$x \\approx 395$<br><br><strong>Svar:</strong> Det tar ca $395$ ladesykluser.<br><br><strong>d)</strong><br>Hvis syklusene øker med $30\\%$, er vekstfaktoren $1.3$. Endringen i kapasiteten vil da være $1.3^{-0.15}$.<br><br>$1.3^{-0.15} \\approx 0.961$<br><br>Dette gir en ny kapasitet på $96.1\\%$ av den forrige. Vi finner nedgangen:<br><br>$1 - 0.961 = 0.039 = 3.9\\%$<br><br><strong>Svar:</strong> Nedgangen i kapasitet er $3.9\\%$.",
                        "fasitSteg": null
                    }
                ],
                "quiz": null
            },
            {
                ...
                "oppgaver": [
                    ...
                    },
                    {
                        ...
                        "fasit": "<strong>a)</strong><br>Vi bruker standardformen for en eksponentialfunksjon, $B(x) = a \\cdot b^x$.<br><br>$a = 10$ (startverdien er $10$ millioner)<br><br>$b = 1.03$ (vekstfaktoren tilsvarende $3 \\%$ økning)<br><br>$B(x) = 10 \\cdot 1.03^x$ (setter $a$ og $b$ inn i uttrykket)<br><br><strong>Svar:</strong> $B(x) = 10 \\cdot 1.03^x$<br><br><strong>b)</strong><br>Vi skal finne antall bakterier etter ett år, så vi setter $x = 365$.<br><br>$B(365) = 10 \\cdot 1.03^{365}$ (setter inn verdien for $x$)<br><br>$B(365) \\approx 10 \\cdot 48482.7$ (regner ut potensen)<br><br>$B(365) \\approx 484827$ (ganger med startverdien)<br><br>Siden startverdien $10$ var oppgitt i millioner, er svaret også i millioner.<br><br><strong>Svar:</strong> Omtrent $484827$ millioner bakterier",
                        "fasitSteg": null
                    },
                    {
                        "id": "4.39",
                        ...
                        "fasit": "<strong>a)</strong><br>Bilens verdi som ny er verdien når $t = 0$.<br><br>$V(0) = 400000 \\cdot 0.85^0$ (setter inn $t = 0$)<br><br>$V(0) = 400000 \\cdot 1$ (ethvert tall opphøyd i $0$ er $1$)<br><br>$V(0) = 400000$<br><br><strong>Svar:</strong> $400000$ kr<br><br><strong>b)</strong><br>Vekstfaktoren $b$ er $0.85$.<br><br>$p = (0.85 - 1) \\cdot 100 \\%$ (finner prosentvis endring)<br><br>$p = -0.15 \\cdot 100 \\% = -15 \\%$ (regner ut differansen og gjør om til prosent)<br><br>Det negative fortegnet betyr en nedgang.<br><br><strong>Svar:</strong> $15 \\%$ nedgang<br><br><strong>c)</strong><br>Funksjonen $V(t)$ er en eksponentialfunksjon med startverdi $400000$ og vekstfaktor under $1$.<br><br>Grafen starter dermed i y-aksen på verdien $400000$.<br><br>Fordi $b = 0.85 < 1$, vil grafen falle kontinuerlig når vi går mot høyre på x-aksen, men den vil aldri krysse x-aksen (den flater gradvis ut).<br><br><strong>Svar:</strong> En fallende eksponentialkurve som starter i $(0, 400000)$.<br><br><strong>d)</strong><br>Vi setter $t = 4$ for å finne verdien etter $4$ år.<br><br>$V(4) = 400000 \\cdot 0.85^4$ (setter inn $t = 4$)<br><br>$V(4) \\approx 400000 \\cdot 0.5220$ (beregner potensen)<br><br>$V(4) \\approx 208802.5$ (ganger ut)<br><br><strong>Svar:</strong> $208803$ kr<br><br><strong>e)</strong><br>Vi vil finne tiden $t$ når verdien $V(t)$ er halvparten av startverdien ($200000$).<br><br>$400000 \\cdot 0.85^t = 200000$ (setter funksjonen lik den halve verdien)<br><br>$0.85^t = \\frac{200000}{400000}$ (deler på $400000$ på begge sider)<br><br>$0.85^t = 0.5$ (forenkler brøken)<br><br>$\\ln(0.85^t) = \\ln(0.5)$ (tar den naturlige logaritmen på begge sider for å hente ned eksponenten)<br><br>$t \\cdot \\ln(0.85) = \\ln(0.5)$ (bruker logaritmeregel for potens)<br><br>$t = \\frac{\\ln(0.5)}{\\ln(0.85)}$ (isolerer $t$)<br><br>$t \\approx 4.26$<br><br><strong>Svar:</strong> $4.26$ år",
                        "fasitSteg": null
                    },
                    {
                        "id": "4.40",
                    ...
                    },
                    {
                        ...
                        "fasit": "<strong>a)</strong><br>En økning på $4 \\%$ gir en vekstfaktor på $b = 1.04$.<br>Fra 2015 til 2020 har det gått $5$ år ($t = 5$).<br>Startverdien for denne perioden er verdien i 2015, så $a = 25000$.<br><br>$V_{2020} = 25000 \\cdot 1.04^5$ (setter opp uttrykket for å finne verdi fremover i tid)<br><br>$V_{2020} = 25000 \\cdot 1.21665$ (regner ut potensen)<br><br>$V_{2020} \\approx 30416.3$ (ganger ut)<br><br><strong>Svar:</strong> $30416$ kr<br><br><strong>b)</strong><br>Fra 2010 til 2015 er det $5$ år.<br>Hvis verdien i 2010 er startverdien $V_{2010}$, vet vi at:<br><br>$V_{2010} \\cdot 1.04^5 = 25000$ (verdien vokser i $5$ år frem til $25000$)<br><br>$V_{2010} = \\frac{25000}{1.04^5}$ (vi deler på $1.04^5$ på begge sider for å isolere $V_{2010}$)<br><br>$V_{2010} = 25000 \\cdot 1.04^{-5}$ (vi kan også se på dette som å gå $5$ år bakover i tid, $t = -5$)<br><br>$V_{2010} \\approx \\frac{25000}{1.21665}$<br><br>$V_{2010} \\approx 20548.2$<br><br><strong>Svar:</strong> $20548$ kr<br><br><strong>c)</strong><br>Total vekstfaktor for hele tiårsperioden fra 2010 til 2020 finnes ved å opphøye den årlige vekstfaktoren i antall år ($10$ år).<br><br>$b_{total} = 1.04^{10}$ (regner ut total vekstfaktor)<br><br>$b_{total} \\approx 1.4802$<br><br>For å finne den prosentvise økningen trekker vi fra $1$ og gjør om til prosent:<br><br>$(1.4802 - 1) \\cdot 100 \\% = 0.4802 \\cdot 100 \\% = 48.02 \\%$<br><br><strong>Svar:</strong> $48 \\%$ økning",
                        "fasitSteg": null
                    },
                    {
                        "id": "4.43",
                        ...
                        "fasit": "<strong>a)</strong><br>Halveringstiden $T$ er definert som den tiden det tar før en verdi er halvert, uavhengig av når i forløpet man starter å måle. <br>Ved tidspunktet $t$ er verdien $f(t)$. Når det har gått ytterligere $T$ tidsenheter, er tiden $t+T$. Verdien må da være halvparten av hva den var ved tidspunktet $t$. <br>Derfor må $f(t+T)$ være lik $0.5$ ganget med $f(t)$.<br><br><strong>Svar:</strong> Etter $T$ tidsenheter har verdien alltid blitt halvparten av det den var ved ethvert starttidspunkt $t$.<br><br><strong>b)</strong><br>Vi tar utgangspunkt i likningen $f(t+T) = 0.5 \\cdot f(t)$. Vi setter funksjonsuttrykket $f(x) = a \\cdot b^x$ inn på begge sider:<br><br>$a \\cdot b^{t+T} = 0.5 \\cdot a \\cdot b^t$ (setter inn uttrykkene for $f$)<br><br>$a \\cdot b^t \\cdot b^T = 0.5 \\cdot a \\cdot b^t$ (bruker potensregelen $b^{x+y} = b^x \\cdot b^y$ på venstre side for å skille ut leddene)<br><br>$\\frac{a \\cdot b^t \\cdot b^T}{a \\cdot b^t} = \\frac{0.5 \\cdot a \\cdot b^t}{a \\cdot b^t}$ (deler på $a \\cdot b^t$ på begge sider)<br><br>$b^T = 0.5$ ($a$ og $b^t$ forkortes bort)<br><br>Dermed har vi vist at $b^T = 0.5$.<br><br><strong>Svar:</strong> $b^T = 0.5$<br><br><strong>c)</strong><br>Resultatet i b) inneholder verken $a$ (startverdien) eller $t$ (hvilket tidspunkt vi begynte å måle fra). Det avhenger kun av vekstfaktoren $b$ og halveringstiden $T$.<br><br><strong>Svar:</strong> Dette forteller oss at halveringstiden er konstant og uavhengig av startverdien. Den avhenger kun av den faste vekstfaktoren.",
                        "fasitSteg": null
                    }
                ],
                "quiz": null
                ...
                "oppgaver": [
                    {
                        ...
                        "fasit": "Gjennomsnittlig vekstfart beskriver endringen over et helt intervall fra $x_1$ til $x_2$. Dette tilsvarer stigningstallet til en sekant som går gjennom disse to punktene på grafen.<br><br>Det regnes ut med formelen:<br>$\\frac{f(x_2) - f(x_1)}{x_2 - x_1}$<br><br>Momentan vekstfart beskriver endringen i akkurat ett bestemt punkt. Dette tilsvarer stigningstallet til tangenten i dette punktet. <br><br>Vi finner den momentane vekstfarten ved å derivere funksjonen, $f'(x)$, og sette inn $x$-verdien til punktet.<br><br><strong>Svar:</strong> Gjennomsnittlig vekstfart regnes med $\\frac{f(x_2) - f(x_1)}{x_2 - x_1}$, og momentan vekstfart med $f'(x)$.",
                        "fasitSteg": null
                    },
                    {
                        "id": "4.45",
                        ...
                        "fasit": "<strong>a)</strong><br>Vi finner først funksjonsverdiene i endepunktene av intervallene:<br>$f(0) = -0^2 + 4 \\cdot 0 + 2 = 2$<br>$f(2) = -2^2 + 4 \\cdot 2 + 2 = -4 + 8 + 2 = 6$<br>$f(4) = -4^2 + 4 \\cdot 4 + 2 = -16 + 16 + 2 = 2$<br><br>Gjennomsnittlig vekstfart for $[0, 2]$:<br>$\\frac{f(2) - f(0)}{2 - 0} = \\frac{6 - 2}{2} = \\frac{4}{2} = 2$<br><br>Gjennomsnittlig vekstfart for $[2, 4]$:<br>$\\frac{f(4) - f(2)}{4 - 2} = \\frac{2 - 6}{2} = \\frac{-4}{2} = -2$<br><br><strong>Svar:</strong> Gjennomsnittsfarten er $2$ i intervallet $[0, 2]$ og $-2$ i intervallet $[2, 4]$.<br><br><strong>b)</strong><br>Momentan vekstfart for $x=2$ er det samme som stigningstallet til tangenten i dette punktet. Dette finner vi ved å bruke den deriverte, $f'(x)$.<br><br>Vi deriverer funksjonen:<br>$f'(x) = -2x + 4$<br><br>Vi setter inn $x = 2$:<br>$f'(2) = -2 \\cdot 2 + 4 = -4 + 4 = 0$<br><br>Siden stigningstallet er $0$, har tangenten null stigning, som betyr at grafen har et toppunkt her.<br><br><strong>Svar:</strong> Den momentane vekstfarten når $x=2$ er $0$.<br><br><strong>c)</strong><br>Vi bruker den deriverte $f'(x) = -2x + 4$ fra oppgave b.<br><br>Setter inn $x = 3$:<br>$f'(3) = -2 \\cdot 3 + 4 = -6 + 4 = -2$<br><br><strong>Svar:</strong> Den momentane vekstfarten når $x=3$ er $-2$.<br><br><strong>d)</strong><br>Vi bruker igjen den deriverte $f'(x) = -2x + 4$.<br><br>Setter inn $x = 0$:<br>$f'(0) = -2 \\cdot 0 + 4 = 0 + 4 = 4$<br><br><strong>Svar:</strong> Den momentane vekstfarten når $x=0$ er $4$.",
                        "fasitSteg": null
                    },
                    {
                        "id": "4.46",
                        ...
                        "fasit": "<strong>a)</strong><br>Stigningstallet til tangenten er gitt i oppgaveteksten.<br>Grafen stiger med $15$ $y$-enheter per $x$-enhet akkurat i dette punktet.<br><br><strong>Svar:</strong> Stigningstallet til tangenten er $15$.<br><br><strong>b)</strong><br>Momentan vekstfart i et punkt er definert som stigningstallet til tangenten i det samme punktet.<br>Siden punktet har $x=20$ og vi vet fra oppgave a at stigningstallet her er $15$, er også den momentane vekstfarten $15$.<br><br><strong>Svar:</strong> Den momentane vekstfarten i $x=20$ er $15$.<br><br><strong>c)</strong><br>Vi vet at punktene for $x=20$ og $x=40$ er $(20, 300)$ og $(40, 500)$.<br>Gjennomsnittsfart over et intervall er stigningstallet til sekanten som går gjennom punktene:<br><br>$\\frac{f(x_2) - f(x_1)}{x_2 - x_1}$<br><br>Vi setter inn punktene vi har:<br>$\\frac{500 - 300}{40 - 20} = \\frac{200}{20} = 10$<br><br><strong>Svar:</strong> Gjennomsnittsfarten i intervallet $[20, 40]$ er $10$.",
                        "fasitSteg": null
                    },
                    {
                        "id": "4.47",
                    ...
                    },
                    {
                        ...
                        "fasit": "<strong>a)</strong><br>*Skisse av graf mangler, men du kan lage en tabell med verdier fra $-4$ til $4$ og tegne grafen.*<br><br><strong>Svar:</strong> (Se din egen skisse)<br><br><strong>b)</strong><br>*Du kan finne stigningstallene ved å tegne tangentene i disse punktene og lese av hvor mange $y$-enheter grafen stiger per $x$-enhet.*<br><br><strong>Svar:</strong> Begge tangentene skal ha stigningstall $1$.<br><br><strong>c)</strong><br>Vi finner momentan vekstfart ved å derivere funksjonen:<br>$f'(x) = 3 \\cdot 0.25x^{3-1} - 2 = 0.75x^2 - 2$<br><br>Setter inn $x = -2$:<br>$f'(-2) = 0.75 \\cdot (-2)^2 - 2 = 0.75 \\cdot 4 - 2 = 3 - 2 = 1$<br><br>Setter inn $x = 2$:<br>$f'(2) = 0.75 \\cdot 2^2 - 2 = 0.75 \\cdot 4 - 2 = 3 - 2 = 1$<br><br><strong>Svar:</strong> Momentan vekstfart er $1$ for både $x=-2$ og $x=2$.<br><br><strong>d)</strong><br>Vi setter momentan vekstfart, $f'(x)$, lik $0$ og løser for $x$:<br>$0.75x^2 - 2 = 0$<br><br>Flytter over tallet:<br>$0.75x^2 = 2$<br><br>Deler på $0.75$:<br>$x^2 = \\frac{2}{0.75} = \\frac{2}{\\frac{3}{4}} = \\frac{8}{3}$<br>$x^2 \\approx 2.67$<br><br>Tar kvadratroten av begge sider:<br>$x = \\pm \\sqrt{2.67} \\approx \\pm 1.63$<br><br>Dette er $x$-verdiene der funksjonen har et topp- eller bunnpunkt (tangenten er vannrett).<br><br><strong>Svar:</strong> Momentan vekstfart er $0$ for $x \\approx 1.63$ og $x \\approx -1.63$.<br><br><strong>e)</strong><br>Vi setter momentan vekstfart lik $1$ og løser for $x$:<br>$0.75x^2 - 2 = 1$<br><br>Flytter over tallet:<br>$0.75x^2 = 3$<br><br>Deler på $0.75$:<br>$x^2 = \\frac{3}{0.75} = 4$<br><br>Tar kvadratroten av begge sider:<br>$x = \\pm \\sqrt{4}$<br>$x = \\pm 2$<br><br><strong>Svar:</strong> Momentan vekstfart er $1$ når $x = -2$ og når $x = 2$.",
                        "fasitSteg": null
                    },
                    {
                        "id": "4.49",
                ...
                "oppgaver": [
                    {
                        ...
                        "fasit": "<strong>a)</strong><br>Den deriverte representerer den momentane vekstfarten, som grafisk sett er stigningstallet til tangenten i et punkt på grafen. Dette forteller oss hvor raskt funksjonen endrer seg akkurat der.<br><br><strong>Svar:</strong> Den deriverte er funksjonens momentane vekstfart (stigningstallet til tangenten).<br><br><strong>b)</strong><br>Fortegnet til den deriverte forteller oss hvordan funksjonen utvikler seg:<br>- Positivt fortegn ($f'(x) > 0$) betyr at funksjonsverdien øker (grafen stiger).<br>- Null ($f'(x) = 0$) betyr at funksjonen verken øker eller minker der (flat tangent).<br>- Negativt fortegn ($f'(x) < 0$) betyr at funksjonsverdien minker (grafen synker).<br><br><strong>Svar:</strong> Fortegnet viser om funksjonen stiger (positiv), synker (negativ), eller flater ut (null).<br><br><strong>c)</strong><br>Et ekstremalpunkt (toppunkt eller bunnpunkt) oppstår der grafen snur fra å stige til å synke, eller omvendt. I disse punktene er tangenten vannrett, noe som betyr at stigningstallet er null. Deretter sjekker man gjerne fortegnslinjen til $f'(x)$ for å avgjøre om det er topp- eller bunnpunkt.<br><br><strong>Svar:</strong> Sett $f'(x) = 0$ for å finne kandidater, da grafen har vannrett tangent ved lokale ekstremalpunkter.",
                        "fasitSteg": null
                    },
                    {
                        "id": "4.51",
                        ...
                        "fasit": "<strong>a)</strong><br>Vi skal derivere funksjonen $f(x) = 5x - 3$<br><br>$f'(x) = (5x - 3)'$<br>$\\rightarrow f'(x) = 5 - 0 = 5$ (Konstantleddet -3 forsvinner, og x-leddet beholder koeffisienten)<br><br>Siden $f'(x)$ er en konstant funksjon, vil verdien for $x = 2$ også være 5.<br>$f'(2) = 5$<br><br><strong>Svar:</strong> $f'(x) = 5$ og $f'(2) = 5$<br><br><strong>b)</strong><br>Vi skal derivere funksjonen $f(x) = -x + 4$<br><br>$f'(x) = (-x + 4)'$<br>$\\rightarrow f'(x) = -1 + 0 = -1$ (x forsvinner og vi står igjen med stigningstallet -1)<br><br>Vi regner ut for $x = 2$:<br>$f'(2) = -1$<br><br><strong>Svar:</strong> $f'(x) = -1$ og $f'(2) = -1$<br><br><strong>c)</strong><br>Vi skal derivere funksjonen $f(x) = \\sqrt{3} \\cdot x$<br><br>$f'(x) = (\\sqrt{3} \\cdot x)'$<br>$\\rightarrow f'(x) = \\sqrt{3}$ (Koeffisienten $\\sqrt{3}$ blir stående)<br><br>Vi regner ut for $x = 2$:<br>$f'(2) = \\sqrt{3}$<br><br><strong>Svar:</strong> $f'(x) = \\sqrt{3}$ og $f'(2) = \\sqrt{3}$<br><br><strong>d)</strong><br>Vi skal derivere funksjonen $f(x) = -7$<br><br>$f'(x) = (-7)'$<br>$\\rightarrow f'(x) = 0$ (En ren konstant har ingen endring, altså er den deriverte 0)<br><br>Vi regner ut for $x = 2$:<br>$f'(2) = 0$<br><br><strong>Svar:</strong> $f'(x) = 0$ og $f'(2) = 0$",
                        "fasitSteg": null
                    },
                    {
                        "id": "4.52",
                        ...
                        "fasit": "<strong>a)</strong><br>En fortegnslinje gir en visuell oversikt over funksjonens fortegn for ulike x-verdier. Den viser om funksjonsverdien er positiv, negativ eller null.<br>- Positiv verdi markeres vanligvis med en heltrukken strek.<br>- Negativ verdi markeres med en stiplet strek.<br>- Et kryss eller en null viser punktet hvor uttrykket er nøyaktig null (et nullpunkt).<br><br><strong>Svar:</strong> Den viser visuelt i hvilke intervaller funksjonen (eller uttrykket) er positiv og negativ.<br><br><strong>b)</strong><br>Først må vi finne nullpunktet til funksjonen $f(x) = x + 3$.<br><br>$x + 3 = 0$ (Sett funksjonsuttrykket lik null)<br>$\\rightarrow x = -3$ (Flytt 3 over, bytt fortegn)<br><br>Nå må vi finne ut om funksjonen er positiv eller negativ på hver side av nullpunktet:<br>Test for en verdi mindre enn -3 (f.eks. $x = -4$): $f(-4) = -4 + 3 = -1$ (Negativ verdi)<br>Test for en verdi større enn -3 (f.eks. $x = 0$): $f(0) = 0 + 3 = 3$ (Positiv verdi)<br><br>Fortegnslinjen skal dermed ha:<br>- En nullverdi ved $x = -3$<br>- Stiplet strek for $x < -3$<br>- Heltrukken strek for $x > -3$<br><br><strong>Svar:</strong> Null for $x = -3$. Stiplet linje for verdier før -3, heltrukken linje for verdier etter.",
                        "fasitSteg": null
                    },
                    {
                        "id": "4.53",
                        ...
                        "fasit": "<strong>a)</strong><br>Vi finner nullpunktene ved å sette $g(x) = 0$:<br><br>$-x^2 + 4x = 0$<br><br>Vi faktoriserer uttrykket ved å trekke $x$ utenfor en parentes:<br>$x(-x + 4) = 0$<br><br>Dette gir oss to løsninger (når et av leddene er null, er uttrykket null):<br>$x = 0$<br>ELLER<br>$-x + 4 = 0 \\rightarrow x = 4$<br><br><strong>Svar:</strong> Nullpunktene er $x = 0$ og $x = 4$.<br><br><strong>b)</strong><br>For å tegne fortegnslinjen for $g(x)$ baserer vi oss på nullpunktene $x = 0$ og $x = 4$. Vi velger testverdier mellom og utenfor disse punktene:<br><br>- $x < 0$ (f.eks. $x = -1$): $g(-1) = -(-1)^2 + 4(-1) = -1 - 4 = -5$ (Negativ, stiplet linje)<br>- $0 < x < 4$ (f.eks. $x = 2$): $g(2) = -(2)^2 + 4(2) = -4 + 8 = 4$ (Positiv, heltrukken linje)<br>- $x > 4$ (f.eks. $x = 5$): $g(5) = -(5)^2 + 4(5) = -25 + 20 = -5$ (Negativ, stiplet linje)<br><br><strong>Svar:</strong> Fortegnslinjen for $g(x)$ har nullpunkter ved $x = 0$ og $x = 4$. Den er stiplet for $x < 0$, heltrukken for $0 < x < 4$, og stiplet for $x > 4$.<br><br><strong>c)</strong><br>Vi skal først finne den deriverte funksjonen $g'(x)$:<br><br>$g(x) = -x^2 + 4x$<br>$\\rightarrow g'(x) = -2x^{2-1} + 4 \\cdot 1$ (Bruk regelen for potenser: derivert av $x^n$ er $n \\cdot x^{n-1}$)<br>$\\rightarrow g'(x) = -2x + 4$<br><br>Så finner vi nullpunktet for den deriverte for å lage fortegnslinje:<br>$-2x + 4 = 0$<br>$\\rightarrow 2x = 4$<br>$\\rightarrow x = \\frac{4}{2} = 2$<br><br>Vi tester fortegnet:<br>- For $x < 2$ (f.eks. $x = 0$): $g'(0) = -2(0) + 4 = 4$ (Positiv, heltrukken linje)<br>- For $x > 2$ (f.eks. $x = 3$): $g'(3) = -2(3) + 4 = -2$ (Negativ, stiplet linje)<br><br><strong>Svar:</strong> $g'(x) = -2x + 4$. Fortegnslinjen for den deriverte har null i $x = 2$, er heltrukken før 2, og stiplet etter.<br><br><strong>d)</strong><br>Vi setter inn verdien $x = 3$ i den deriverte funksjonen vi fant i c):<br><br>$g'(3) = -2 \\cdot 3 + 4$<br>$\\rightarrow g'(3) = -6 + 4$<br>$\\rightarrow g'(3) = -2$<br><br>Dette forteller oss at grafen til $g(x)$ synker med stigningstall -2 når $x = 3$.<br><br><strong>Svar:</strong> $g'(3) = -2$<br><br><strong>e)</strong><br>Vi løser likningen ved å sette uttrykket for $g'(x)$ fra c) lik 0:<br><br>$g'(x) = 0$<br>$-2x + 4 = 0$ (Sett inn uttrykket for $g'(x)$)<br>$2x = 4$ (Flytt $-2x$ over til høyre side for å få et positivt ledd)<br>$x = \\frac{4}{2}$ (Del på 2 på begge sider)<br>$x = 2$<br><br>Denne løsningen gir oss x-verdien der grafen til $g$ har et bunn- eller toppunkt, noe vi også fant i c).<br><br><strong>Svar:</strong> $x = 2$",
                        "fasitSteg": null
                    },
                    {
                        "id": "4.54",
